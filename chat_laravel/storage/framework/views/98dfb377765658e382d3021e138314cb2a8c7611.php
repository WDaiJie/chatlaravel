                ...
                <div class="card-header"><?php echo e(ucwords(Auth::user()->name)); ?></div>
                     <div class="card-body">
                        ...
                        <?php endif; ?>
                            ...
                            <?php endif; ?>
                                <?php $__currentLoopData = $FriendRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $frindkey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="row" style="border-bottom: 1px solid rgba(11, 4, 76, 0.7);margin-bottom: 18px;">
                                        ...
                                        <div class="col-md-3 pull-right">                                               
                                                 <p><a href="<?php echo e(url('/acceptfriend')); ?>/<?php echo e($frindkey->name); ?>/<?php echo e($frindkey->id); ?>" class="btn btn-info btn-sm">Confirm</a>                                                                                      
                                                 <a href="<?php echo e(url('/requestremovefriend')); ?>/<?php echo e($frindkey->id); ?>" class="btn btn-danger btn-sm">Remove</a></p>      
                                        </div>
                                </div>
...
<?php echo $__env->make('profile.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\chat_laravel\resources\views/profile/requestfriends.blade.php ENDPATH**/ ?>